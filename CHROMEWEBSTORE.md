...
| 版本号 | 发布日期 | 更新内容 | 审核状态 |
| :--- | :--- | :--- | :--- |
| **1.0.0** | 2026-05-21 | - 首次公开发布版本r- 支持划词自动展示 Lens 悬浮按钮及右键菜单拉起侧边栏<br>- 支持 Gemini API, OpenAI, Claude API 及自定义 / 本地大模型 (Ollama, LM Studio 等)<br>- 支持本地开发者 AI Agent (Claude Code, Codex Agent, Gemini Agent 等)<br>- 支持本地模型智能同步：点击「🔄 Sync」一键拉取本地模型列表<br>- 支持附加完整网页正文、代码上下文及 URL 引用功能<br>- 支持 Ctrl + Enter 快捷发送，Enter 回车折行输入<br>- 拥有精致的毛玻璃浅色设计界面<br>- 完全隐私本地化：数据不经任何中转服务器 | 🚨 准备提交审核 |
